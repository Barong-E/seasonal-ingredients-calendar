 ...
 * - 제철음식 5개 (매일 5개씩 순환)
 */
public class SeasonalLargeWidget extends AppWidgetProvider {
    ...
    static void updateWidget(Context context, AppWidgetManager manager, int widgetId) {
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_seasonal_large);
        ...
        int[] catIds   = {R.id.tv_category1, R.id.tv_category2, R.id.tv_category3, R.id.tv_category4, R.id.tv_category5};
    ...
    static PendingIntent getLaunchIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, 3, intent,
