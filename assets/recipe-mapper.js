...
export function getRecipeIdFromDishName(dishName) {
  const mapping = {
    ...
    "당근라페": "recipe-carrot-lape",
    "당근전": "recipe-carrot-jeon",
    "양배추쌈": "recipe-cabbage-ssam",
    "양배추전": "recipe-cabbage-jeon",
    "우럭매운탕": "recipe-rockfish-maeuntang",
    "우럭구이": "recipe-rockfish-gui",
    ...
    "양송이버섯구이": "button-mushroom-gui",
    "양송이버섯버터볶음": "button-mushroom-butter-fry",
