...
const CACHE_KEY = 'seasons:ingredients:v86';
const CACHE_TTL_MS = 24 * 60 * 60 * 1000; // 24h

// 구버전 캐시 강제 삭제 (버전 충돌 방지)
try {
  localStorage.removeItem('seasons:ingredients:v85');
  localStorage.removeItem('seasons:ingredients:v84');
  localStorage.removeItem('seasons:ingredients:v83');
  localStorage.removeItem('seasons:ingredients:v82');
  localStorage.removeItem('seasons:ingredients:v81');
  localStorage.removeItem('seasons:ingredients:v80');
  localStorage.removeItem('seasons:ingredients:v79');
  localStorage.removeItem('seasons:ingredients:v78');
  localStorage.removeItem('seasons:ingredients:v77');
  localStorage.removeItem('seasons:ingredients:v76');
  localStorage.removeItem('seasons:ingredients:v75');
  localStorage.removeItem('seasons:ingredients:v74');
  localStorage.removeItem('seasons:ingredients:v73');
  localStorage.removeItem('seasons:ingredients:v72');
...
async function loadIngredients() {
  ...
  const res = await fetch('data/ingredients.json?v=v66', { cache: 'no-cache' });
